...
describe 'mysql::db', type: :define do
  on_supported_os.each do |os, facts|
    context "on #{os}" do
      ...
      it 'reports an error when ensure is not present or absent' do
        params['ensure'] = 'invalid_val'
      ...
      it 'reports an error if sql isn\'t a string or an array' do
        params['sql'] = { 'foo' => 'test_sql', 'bar' => 'test_2_sql' }
        expect { catalogue }.to raise_error(Puppet::Error,
