...
class mysql::config(
  ...
  if $root_password != 'UNSET' {
    ...
    exec { 'set_mysql_rootpw':
      command   => "mysqladmin -u root ${old_pw} password '${root_password}' ; mysql -u root -e \"SET PASSWORD FOR 'root'@'127.0.0.1' = PASSWORD('${root_password}'); SET PASSWORD FOR 'root'@'::1' = PASSWORD('${root_password}');\"",
      logoutput => true,
