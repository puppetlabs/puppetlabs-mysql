...
class mysql::bindings (
  ...
  Stdlib::Ensure::Package $java_package_ensure       = $mysql::params::java_package_ensure,
  ...
  Stdlib::Ensure::Package $perl_package_ensure       = $mysql::params::perl_package_ensure,
  ...
  Stdlib::Ensure::Package $php_package_ensure        = $mysql::params::php_package_ensure,
  ...
  Stdlib::Ensure::Package $python_package_ensure     = $mysql::params::python_package_ensure,
  ...
  Stdlib::Ensure::Package $ruby_package_ensure       = $mysql::params::ruby_package_ensure,
  ...
  Stdlib::Ensure::Package $client_dev_package_ensure = $mysql::params::client_dev_package_ensure,
  ...
  Stdlib::Ensure::Package $daemon_dev_package_ensure = $mysql::params::daemon_dev_package_ensure,
