...
group :system_tests do
  ...
  gem "puppet_litmus",                                require: false, git: 'https://github.com/pmcmaw/puppet_litmus.git', branch: 'remove_bolt_dependency', platforms: [:ruby] if ENV['PUPPET_GEM_VERSION'].nil? or ENV['PUPPET_GEM_VERSION'] !~ %r{ 5}
